            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Lun-Sab 9am-6pm</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="https://mail.google.com/mail/u/0/#inbox" class="title">{{ $settings->contact_email}}</a>
                            <p class="sub-title">Soporte en línea</p>
                        </div>
                    </div>
                </div>
