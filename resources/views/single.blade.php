                            ...
                            <div class="post-additional-info">
                                ...
                                <div class="post__author author vcard">
                                    ...
                                    <div class="post__author-name fn">
                                        <a href="#" class="post__author-link">Alexander Castillo G.</a>
                                    </div>
                ...
                <div class="addthis_inline_share_toolbox"></div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ asset($post->user->profile->avatar) }}" alt="{{ $post->user->name}}" height="90px" width="90px" style="border-radius: 50%;">
                        </div>
                    ...
                    <div class="pagination-arrow">
                        ...
                        @if ($prev)
                            ...
                            <div class="btn-content">
                                <div class="btn-content-title">Anterior Post</div>
                        ...
                        <a href="{{ route('post.single', ['slug'=>$next->slug]) }}/" class="btn-next-wrap">
                            <div class="btn-content">
                                <div class="btn-content-title">Siguiente Post</div>
